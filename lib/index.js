 ...
 */
var COMPONENT_NAMES = ['Translate', 'FormattedHTMLMessage'];
    ...
    visitor: {
      JSXOpeningElement: function JSXOpeningElement(path, state) {
        ...
        if (name.referencesImport(moduleSourceName, 'FormattedPlural')) {
          file.log.warn("[React Intl] Line ".concat(path.node.loc.start.line, ": ") + 'Default messages are not extracted from ' + '<FormattedPlural>, use <Translate> instead.');
          return;
        }
